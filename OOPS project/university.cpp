...
void resultmodify_record(char indx[])
{
    ...
    for (i = 0; i < no; i++)
    {
...

        {
            ...
            cin >> unirec[i].sem;
            cout << "\nTheory1  : ";
            cin >> unirec[i].theory1;
            cout << "\nTheory2  : ";
            cin >> unirec[i].theory2;
            cout << "\nTheory3  : ";
            cin >> unirec[i].theory3;
            cout << "\nTheory4  : ";
            cin >> unirec[i].theory4;
            cout << "\nTheory5  : ";
            cin >> unirec[i].theory5;
            cout << "\nTheory6  : ";
            cin >> unirec[i].theory6;
            cout << "\nLab1     : ";
            cin >> unirec[i].lab1;
            cout << "\nLab2     : ";
            cin >> unirec[i].lab2;
        ...
        case 1:
            ...
            for (;;)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    studentdisplay_records();
                    break;
                case 3:
                    studentsearch_records();
                    break;
                case 4:
                    studentmodify_records();
                    break;
                case 5:
                    studentremove_record();
                    break;
                case 6:
                    main();
                    break;
        ...
        case 2:
            ...
            for (;;)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    collegedisplay_records();
                    break;
                case 3:
                    collegesearch_records();
                    break;
                case 4:
                    collegemodify_records();
                    break;
                case 5:
                    collegeremove_record();
                    break;
                case 6:
                    main();
                    break;
        ...
        case 4:
            ...
            for (;;)
            {
                ...
                case 1:
                    ...
                    break;
                case 2:
                    resultdisplay_records();
                    break;
                case 3:
                    resultsearch_records();
                    break;
                case 4:
                    resultmodify_records();
                    break;
                case 5:
                    resultremove_record();
                    break;
